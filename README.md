...
This tool works on the output of the FLOSS files to match FLOSS values to a JSON file in an attempt to detect language based strings. This can give indication of the different language types being used in the malware. This is particularly common in Malware which might display messages to the user in their native language such as Ransomware. 
